...
function Index({success}){
    ...
    return(
        <>
            ...
            //         Repair Admin Request
            //     </h2>
            //     <Link href={route('Repair.create')} className="bg-emerald-500 py-1 px-3 text-white rounded shadow transition-all hover:bg-emerald-600">new request</Link>
            // </div>
                                        ...
                                        return(
                                            <tr key={repair.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" >
                                                ...
                                                {/* <td className="px-3 py-2">
                                                    <img src={repair.image_url} alt="img" />
                                                </td> */}
                                                <td className="px-3 py-2 hover:underline"><Link href={route('Repair.show',repair.id)} >{repair.name}</Link></td>
                                                ...
                                                <td className="px-3 py-2 text-nowrap">
                                                    <Link href={route('Repair.edit' , repair.id)} className="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1">
                                                        Edit
                                                    </Link>
